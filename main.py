...
def main(path=None):
    ...
    sent_dic = lyricsfunc.mood(names_list, song_lyrics)
    kidsafe_dic = lyricsfunc.kid_safe(
        names_list, notsafe_l, sent_dic, song_lyrics)
    ...
    sentdic, lovedic, kidsafedic, lengthdic, comdic = lyricsfunc.result_rank(
        sent_dic, love_dic, kidsafe_dic, length_dic, com_dic, song_details)
    result = lyricsfunc.get_finaldic(
        sentdic, lovedic, kidsafedic, lengthdic,
        comdic, song_details, names_list)
    finalresult = {}
